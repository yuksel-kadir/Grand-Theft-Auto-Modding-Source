...
public:
	...
	//DRIVER MODEL IDS
	static const short TAXI_DRIVER_MODEL_1 = 28;
	static const short TAXI_DRIVER_MODEL_2 = 74;
	//TAXI MODEL IDS
	static const short TAXI_MODEL_1 = 150;
	static const short TAXI_MODEL_2 = 168;
	static const short TAXI_MODEL_3 = 216;
	//Sound List -> https://gist.github.com/WastedHymn/ac8b59d17734138725b376a5e5d83c90
	static const unsigned short HELP_MESSAGE_SOUND = 179;
	//Multiplier
	static constexpr float COST_MULTIPLIER = 0.05f;
	//funcs
	...
	static bool CheckBridgeStatus(int& bridgeStatusGlobalVariableID);
	...
	static void TaxiTeleport(CVehicle* taxi, CVector pos, float heading);
