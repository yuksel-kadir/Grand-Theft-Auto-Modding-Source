...
public:
    ...
    TaxiManager() {
        ...
        static int8_t n_selectedDestinationIndex = 0;
                                ...
                                if (!TaxiUtils::taxiStatus.skippingTravel) {
                                    ...
                                    if (TextUtils::destinationTextInfo.showText) {
                                        ...
                                        if ((KeyPressed(VK_DOWN) || KeyPressed(S_KEY)) && InputUtils::IsTimeElapsed(n_keyPressTime, 250)) {
                                            InputUtils::RefreshKeyPressTime(n_keyPressTime);
                                            bool canTaxiGoToDestination = TaxiUtils::CheckBridgeStatus(Destinations::destinationInformationList[n_destinationIndex].globalVariableId);
                                            if (canTaxiGoToDestination) {
                                                ...
                                                if (distanceToDestinationFromCurrentPosition > 20) {
                                                    ...
                                                    if (hasEnoughMoney) {
                                                        ...
                                                        TextUtils::SetTextColor(TextUtils::COLOR_PINK);
                                                ...
                                                TextUtils::PrintQuickHelpMessage(TextUtils::BRIDGE_MSG);
                                            }
                                        }
